...
//TO DO
// const [collateralSymbol, collateralDecimals] = getTokenInfo('COLLATERAL_TOKEN')
// const [bondedSymbol, bondedDecimals] = getTokenInfo('BONDED_TOKEN')
...
/* function getTokenInfo(name){
  const token = useKnownContract(name)
